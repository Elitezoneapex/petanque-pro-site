[DEPLOY.md](https://github.com/user-attachments/files/27415353/DEPLOY.md)
[DEPLOY.md](https://github.com/user-attachments/files/27415290/DEPLOY.md)
# Deploying the Pétanque Pro support site

You have three pages ready to host: `index.html`, `privacy.html`, `support.html` + `styles.css`. Pick whichever option you like — all are free and Apple-a# Deploying the Pétanque Pro support site
...
No account, no git, no CLI.# Deploying the Pétanque Pro support site
